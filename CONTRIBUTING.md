...
To get started with contributing code, we recommend to install `inox` in [editable mode](https://pip.pypa.io/en/latest/topics/local-project-installs) with its development dependencies.
